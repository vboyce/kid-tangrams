...
ggplot(timed_new, aes(x = roundStart, y = wordCount, group = game, color = game)) + 
  geom_line() +
  labs(color = "Game ID", x = "Round #", y = "Utterance Count") +
  #scale_x_continuous(#breaks=seq(1,10,1), limits = c(2,13)) +
  #ylim(120, 200) + 
  theme_classic()
