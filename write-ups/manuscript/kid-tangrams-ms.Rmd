...
Our findings provide a more sophisticated account of children’s early emerging communicative abilities. More recent work on children’s referential abilities shows preschool-aged children's success in an iterated reference task when task demands are reduced and when children are provided the appropriate scaffolding by their parents [@leung2025]. The current studies provide evidence that children are capable of success in an iterated reference task even when parental scaffolding is absent and when interacting with interlocutors with comparable communicative abilities to their own.
