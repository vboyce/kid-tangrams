...
[ may want to pre-flag the *child-child* thing earlier? ]

[in which I very wordily try to set up the rest of the intro, please help]
One influential early study in the 1960s suggested that 4-5-year-old preschoolers struggle with child-child referential communication [@glucksberg1966]. In the past half century, these findings have not been directly contradicted, but the larger understanding of child development has shifted away from a Piagetian framework, where young children are expected to be very different from older children and adults, towards frameworks of core knowledge or naive theory where more early competence is expected [@gelman2024 ;@wellman1992; @gopnik2012]. Along with shifts in theory, methods have also shifted, with a current focus on lowering task demands to pinpoint specific abilities. From this perspective, the classic results, are, while not contradicted by the more recent literature, certainly in tension with more recent work on the development of referential abilities, which paint a mixed, but overall more capable picture of preschooler's referential communication. 

In the rest of the introduction, we review the methods of the classic Glucksberg and Krauss studies, and discuss the larger literature around the development of referential communication skills, and iterated reference games with children. We then situate the specific question of collaborative reference to novel shapes as it fits in with larger questions within language development. Finally, we preview our current study and how it's methods differ from @glucksberg1966. 

## Glucksberg and Krauss's studies 

Glucksberg and Krauss ran a number of studies using their "Stack the Blocks" paradigm [@glucksberg1966; @glucksberg1967; @krauss1969; @krauss1977a]. We focus on the subset involving two children playing the game with each other, as opposed to adult-child experiments, which they also ran. 

In @glucksberg1966, 12 pairs of 4 year old children from a preschool played the block-stacking game. Participants were given 6 blocks which depicted different images.  The speaker received blocks in a pre-set order from the dispenser, and their job was to stack the block on the peg and tell the other child which block to stack so their stacks would match. In the practice phase, children used blocks with animals or colored squares on them; first with visual access to the other child's blocks, and if that was successful, then separated by an opaque barrier. If children correctly stacked the practice blocks two times with the barrier, they moved on to the critical trials (6 pairs of 3 year olds were tested but did not pass the practice trials). Children received feedback in seeing the experimenter compare the two block stacks. 

In follow-up studies, Glucksberg and Krauss recruited children in kindergarten, 1st, 3rd, and 5th grade from an orphanage [@krauss1969]. There were 7 kindergarten pairs and 9 1st grade pairs, and children again received feedback whether or not their block stacks were correct [@krauss1977a]. From @glucksberg1967 and @krauss1977a, there were also mixed-age pairs with a kindergartner describing to another child (including another kindergartener), and same-age pairs from 3rd, 5th, 7th, and 9th grade with did not receive correctness feedback (10 pairs per grade). 

Even after multiple rounds with the same images, the younger children were not able to correctly order the blocks. @glucksberg1966 attributed children's communicative failures to their production of ego-centric descriptions that did not account for the other child's perspective.  @krauss1969 interprets the pattern of children's low performance as consistent with early "linguistic competence"  followed by much later "communication competence". 

How badly were the children doing? For the preschoolers, they never produced an errorless stack of the 6 blocks, and did not show improvement over repetitions (error rates not reported). For the kindergarteners, they were getting about 2/6 right on average (Figure 3 in @krauss1969; Figure 4 in @glucksberg1967), which is numerically above chance, although without knowing the sample sizes and cross-pair variances, we can't say if it is meaningfully different. They report that adult performance is generally error-free even in the first repetition, but the 9th graders had less than 50% of their initial stacks completely correct, rising to around 80% correct at the end [@krauss1977a]. 

These studies are cited uncritically as evidence that young children cannot form referential pacts with each other, but by the experimental practices of modern developmental science, it's not clear that the Glucksberg and Krauss results should be interpreted as a conclusive failure. 

Over time, there have been shifts in how to interpret children's unadultlike behavior in experiments. One framework, expressed in @krauss1969, is a "deficit" framing, where children's performance is directly interpreted in contrast to adults. Another framework looks more at how and when abilities emerge and how they develop and manifest as children mature. Under this second framework, the focus is on when and under what conditions there are signs of underlying competence or knowledge, even if the behaviors are inconsistently expressed. 

As part of this shift, there has been acknowledgement that task demands can task children's generally cognitive resources and thus mask our ability to detect children's early competence. Thus, for instance, @sapp2000 and @rice1997 revealed children had earlier understanding of the difference between appearance and reality by using tasks with lower demands on working memory and executive functioning. 


Under this framework, there is a question whether the performance of the youngest children is actually a complete failure. Moreover, there are substantial concerns on whether this task (where even 9th graders underperform adults) is a good way of measuring the communicative competence of 5 year olds. The interesting question is no longer are 5 year olds worse at things than adults, but instead trying to understand which underlying abilities are present to what extent at 5 years old. As different areas of developmental science see earlier abilities, but only on easier tasks, it then raises the more general question -- is a failure in performance about a complete lack of underlying competence or is it about the task? 

## Development of referential communication and pragmatics 

Though no evidence has directly contradicted @glucksberg1966, a number of studies have revealed early emerging skills in the preschool years that support referential communication. 

One aspect of referential communication is understanding how the amount of shared knowledge should effect what types of utterances are appropriate. In producing utterances, children show experimental sensitivity to numerous markers of common ground. While their utterance choices are not equivalent to adults, children produce more informative utterances more when more informative utterances are appropriate [@vasil2023]. As an example, preschool-aged children adapt the informativeness of their referential expressions based on the visual content available to their interlocutor [@matthews2006;@nadig2002;@nilsen2009]. Children also show sensitivity to other's perspectives when they are the comprehender by 4-5 years old, using clues to common ground to determine what the correct target is. [@sanjuan2015; @ackerman1990]. Children's ability to take partner's perspectives and knowledge states into account is evolving over the preschool years, but overall, by late preschool, children can reason about others’ perspectives to communicate more effectively. 
...
Children are also sensitive as comprehenders to ambiguous utterances, although they have a tendency to pick something even when it is under-specified, and their ability to make meta-linguistic judgements of utterance adequacy is still developing from 5 to 7 years old [@ackerman1990].  By 5 years old, children are sensitive to over- and under-informative utterances, asking for clarification on some under-informative utterances and taking longer to make selections on over-informative utterances [@morisseau2013].

However, 4-5-year-old children's referential abilities are far from mature. In particular, while children are sensitive to others’ perspectives, they still struggle to appropriately tailor the specificity of their utterances to the visual context, often resulting in under-informative utterances [@matthews2012; @leung2024]. In studies where children must pick out one of many referents that vary along combinatorial dimensions (shape, size, color), children often do not mention all the needed dimensions.  When children must describe one of two very similar images, 4 and 5-year-olds sometimes neglect to mention the relevant features, although they do better when playing in an interactive game than when not [@grigoroglou2019]. 

Children are also inconsistent in how they react to feedback after an underspecified utterance. There is some sensitivity to feedback, especially if it is a specific question or being given the wrong object, but overall, children often do not produce adequately specified utterances even in response to feedback [@nilsen2012; @bacso2017; @deutsch1982]. 

A common thread among many developmental studies is that children perform better when the cognitive load of the task is reduced, i.e. when there are fewer possible referents [@abbot-smith2015; @sanjuan2015].  These findings paired with evidence of emerging communicative skills in young children suggest that tailored referential expression production is possible in children, but it is likely to be masked when the task demands are too high, such as when the array of options is large. 



## Iterated reference involving children  

One of the key features of iterated reference games that is not present in other reference games is the initial ambiguity around what to call the target and then the expectation of partner-specific convention formation in how to describe the target in later repetitions. 
...
Another piece of evidence about children's communicative abilities comes from an iterated reference game where 4-8-year-old children used natural language to communicate with their parents [@leung2024]. In this simple, child-friendly tablet-based task, even 4-year-olds had an initial accuracy above 80% on two-way choice, which rose to above 90% in later repetitions [@leung2024]. @leung2024 interpret their results in contrast with the @glucksberg1966 results as a sign that parental scaffolding is what enables children's successful matching. While parents certainly scaffold their interactions with children, it is not clear whether the children's better performance is due only to the parental communication partners or the reduced task demands. 


## Why does it matter how children do this? Broader questions in language development 

Why does it matter how well children can play iterated reference games, or what communicative tacts they use? Children's early communicative behaviors are relevant to some large discussions in the literature around the role of pragmatics in early language development and the range of situations in which language acquisition is measured. 

TODO could also include egocentrism, as a middle debate topic, but idk what to say about it?

In the broader picture of language acquisition, there is debate over the timing of the emergence of communicative and pragmatic abilities relative to the acquisition of grammar and meaning. On one side, children seem to learn literal semantics far before they display an understanding of some pragmatic implicatures [@huang2009; @noveck2001]; on the other, sensitivity to communicative intent is an early emerging skill that develops in parallel with linguistic knowledge and may bootstrap language learning [@bates1974; @bohn2019a; @tomasello2008]. A review of developmental studies of quantity implicates found that while children do gradually improve in their understand of implicatures across a long age-range, their performance is also task dependent, with meta-linguistic judgements being worse assessments that more active tasks [@porrini2023]. 


While much research has historically focused on children's language learning from how their parents talk to and with them, there is increasing acknowledgement that children's language acquisition occurs across a more diverse set of social interactions [@cristia2019;@foushee2024] . In observational research, there is movement toward studying children's early language in more naturalistic interactional contexts, spanning the range of interlocuters that children interact with across different cultures [@bergey2025a;@casillas2023;@girouard-hallam2024]. One dimension is that children's linguistic environment consists of other children. Cross-culturally, children have rich interactions with other children and create, transmit, and learn from peer cultures [@lew-levy2024]. Preschoolers talk to each other, and so some of children's linguistic environment is other children in their classes [@chaparro-moreno2019; @perry2018]. 


While children communicate with other children, there is limited experimental work on young children's communication with each other. In @koymen2014, 4- and 6-year-old children identified nameable objects with another child [a similar task to @brennan1996]. When the visual context changed so that simpler descriptions would be adequate, 6-year-olds (but not 4-year-olds) were more likely to use consistent referential expressions when they keep talking to the same partner, but switch to simpler terms with a new partner [@koymen2014]. Other experiments with pairs of children also reveal that children's speech acts when coordinating on an activity are sensitive to what they think is common knowledge with their partner or not [@short-meyerson1997; @koymen2016; @koymen2014a]. Other child-child communicative studies have looked at iterated learning [@kempe2019], giving each other directions [@resches2007], and asking each other questions [@sanmartin2014]. 

[TODO some sort of summary -- how does our current work connect with these questions? this might want to bleed into next sub-section ]
...
Our current study is of 4 and 5 year old preschoolers, who are most similar in age to the 4 year old preschoolers and kindergarteners in @glucksberg1966 and @krauss1969, and also comparable in age to the 4-year old sample in @leung2024. Compared to @glucksberg1966, we have reduced task demands in that children do not need to stack blocks, instead the describer only needs to say what the target is, and the matcher to select it. Children in our study alternated roles, rather than having a fixed role. We had a total pool of only 4 options in each experiment and only 2 options each trial, rather than the 6 images @glucksberg1966 used. We used tangram images rather than line drawings. Children got feedback after each selection, rather than after every 6 selections. The overall experiment was much shorter, intended to fit within 15 minutes, rather than the 50 minute-limit [@krauss1969]. Our sample sizes were much larger (total of 80 pairs of 4-5s across all experiments), versus their 12 preschool pairs and 7 kindergarten pairs. None of our children were institutionalized.

[maybe this should more just go in expt 1 methods? or just highlight the biggest differences] 
