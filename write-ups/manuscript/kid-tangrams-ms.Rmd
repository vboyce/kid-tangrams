...
[TODO outline of rest of introduction ? ]
...
In follow-up studies, Glucksberg and Krauss recruited children in kindergarten, 1st, 3rd, and 5th grade from an orphanage [@krauss1969]. There were 7 kindergarten pairs and 9 1st grade pairs, and children again received feedback whether or not their block stacks were correct [@krauss1977]. From @glucksberg1967 and @krauss1977, there were also mixed-age pairs with a kindergartner describing to another child (including another kindergartener), and same-age pairs from 3rd, 5th, 7th, and 9th grade with did not receive correctness feedback (10 pairs per grade). 
...
In the past half century, there have been shifts in how to interpret children's unadultlike behavior in experiments. One framework, expressed in CITE Krauss, is a "deficit" framing, where children's performance is directly interpreted in contrast to adults. Another framework looks more at how and when abilities emerge and how they develop and manifest as children mature. Under this second framework, the focus is on when and under what conditions there are signs of underlying competence or knowledge, even if the behaviors are inconsistently expressed. 

As part of this shift, there has been acknowledgement that task demands can task children's generally cognitive resources and thus mask our ability to detect children's early competence. Thus, for instance, in theory of mind, the interpretation of children failing at some theory of mind tasks but succeeding at ones with lower demands on their working memory and executive function, is that there is some early theory of mind ability [ CITE ] . 
...
One aspect of referential communication is understanding how the amount of shared knowledge should effect what types of utterances are appropriate. In producing utterances, children show experimental sensitivity to numerous markers of common ground. While their utterance choices are not equivalent to adults, children produce more informative utterances more when more informative utterances are appropriate [@vasil]. As an example, preschool-aged children adapt the informativeness of their referential expressions based on the visual content available to their interlocutor [@matthews2006;@nadig2002;@nilsen2009]. Children also show sensitivity to other's perspectives when they are the comprehender [@sanjuan2015]. 4-5 year old children are faster to rule out competitors and select the correct target when they have learned that their partner is not aware of the competitor object. Children's ability to take partner's perspectives and knowledge states into account is evolving over the preschool years, but overall, by late preschool, children can reason about others’ perspectives to communicate more effectively. 
...
Children are also sensitive as comprehenders to ambiguous utterances, although they also have a tendency to satisfice [TODO revisit ackerman et al 1990] from the comprehender side, ackerman et al 1990 shows sensitivity to ambiguity but also a tendency to pick something, and not able to do metalinguistic 
 By 5 years old, children are sensitive to over- and under-informative utterances, asking for clarification on some under-informative utterances and taking longer to make selections on over-informative utterances [@morisseau2013].
...
Children are also inconsistent in how they react to feedback after an underspecified utterance. There is some sensitivity to feedback, especially if it is a specific question or being given the wrong object, but overall, children often do not produce adequately specified utterances even in response to feedback [CITES]

responsiveness (or not) to clarification questions 
** nilsen & mangal 2012
** bacso & nilsen 2017 
show some sensitivity to feedback, but also they often don't clarify. 
may also depend on the exact kind of feedback
** deutch & pechmann 1982
...
While much research has historically focused on children's language learning from how their parents talk to and with them, there is increasing acknowledgement that children's language acquisition occurs across a more diverse set of social interactions [@cristia2019;@foushee2024; . 

In observational research, there is movement toward studying children's early language in more naturalistic interactional contexts, spanning the range of interlocuters that children interact with across different cultures [@bergey2025a;@casillas2023;@girouard-hallam2024]. 

One dimension is that children's linguistic environment consists of other children. Cross-culturally, children have rich interactions with other children and create, transmit, and learn from peer cultures [@lew-levy2024]. Preschoolers talk to each other, and so some of children's linguistic environment is other children in their classes [@chaparro-moreno2019; @perry2018]. 


While children communicate with other children, there is limited experimental work on young children's communication with each other. In the iterated learning tradition, @kempe2019 includes a task where 6-7 year olds communicated targets to each other by creating signals from buzzer noises, and another task where 4-year olds do a reference game  with targets that have combinatorial properties (color, size, shape). 

In @resches2007, 3.5 to 6 year old children provided directions to each other about the steps needed to find treasure in a room. 

@sanmartin2014

not repeated is referential: “The development of referential communication: Improving message accuracy by coordinating private speech with peer questioning” 

“Young Children Create Partner-Specific Referential Pacts With Peers” 

should you switch labels or not when a prior label has become over-specific due to context -- w/ or w/o partner switch.

some signs of success but not yet adultlike, and with growth across age range?

reasoning: “Reasoning during joint decision-making by preschool peers” 

3 and 5s in pairs; building a zoo -- give warrants more for unconventional choices than choices using common cultural knowledge

on CG, not totally referential: “Preschoolers Use Common Ground in Their Justificatory Reasoning With Peers” 

3 and 5s; giving reasons for decisions when the reasoning depended on knowledge that was learned separately, rather than when it was learned together.

“Preschoolers’ communication during scripted interactions*” 

15 4-5 yo dyads CG in a scripted interaction that one or both knew about?

[already cited stuff]

When a change in visual context renders previous descriptions overinformative, 6-year-olds (but not 4-year-olds) are more likely to use consistent referential expressions when they keep talking to the same partner, but switch to simpler terms with a new partner [@koymen2014].
